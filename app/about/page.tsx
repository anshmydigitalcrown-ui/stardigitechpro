        ...
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-gray-300 text-lg max-w-3xl mx-auto">
              Learn more about STAR DIGITECH PRO and why businesses trust us
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-7xl mx-auto">
            {/* Who We Are */}
            <div className="group bg-gradient-to-br from-slate-800/60 to-slate-900/60 backdrop-blur-sm p-8 md:p-10 rounded-2xl border border-slate-700/40 hover:border-[#1d7ba8]/50 transition-all duration-300 hover:shadow-xl hover:shadow-[#1d7ba8]/10">
            ...
            <div className="lg:col-span-2 group bg-gradient-to-br from-slate-800/60 to-slate-900/60 backdrop-blur-sm p-8 md:p-10 rounded-2xl border border-slate-700/40 hover:border-[#1d7ba8]/50 transition-all duration-300 hover:shadow-xl hover:shadow-[#1d7ba8]/10">
