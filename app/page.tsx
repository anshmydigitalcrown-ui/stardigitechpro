...
export default function Home() {
  return (
    <>
              ...
              <div className="mt-6 flex justify-center">
                ...
                >
                  <span className="relative z-10 flex items-center gap-2">
                    Book Now<svg className="w-4 h-4 group-hover:translate-x-1 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7l5 5m0 0l-5 5m5-5H6" />
                    </svg>
                  </span>
                </Link>
            ...
            <div className="space-y-6">
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <a
                  ...
                  className="flex items-center gap-3 bg-green-600 hover:bg-green-700 text-white font-semibold px-6 py-4 rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105"
                >
                ...
                <a
                  ...
                  className="flex items-center gap-3 bg-blue-600 hover:bg-blue-700 text-white font-semibold px-6 py-4 rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105"
                >
      ...
      <section className="py-20 bg-gradient-to-b from-slate-900 via-[#0f172a] to-slate-900 relative overflow-hidden">
