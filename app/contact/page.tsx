    ...
    <>
      ...
      <section className="py-20 bg-[#020617]">
        <div className="container mx-auto px-4">
          ...
          <div className="mt-20 bg-gradient-to-b from-rose-50 to-rose-100 -mx-4 px-4 py-16 rounded-3xl">
            <div className="text-center mb-12">
              <h2 className="text-4xl md:text-5xl font-bold text-rose-600 mb-6">
                Contact For Premium Service
              </h2>
              <div className="bg-white rounded-2xl shadow-xl p-6 max-w-4xl mx-auto">
                <p className="text-gray-800 text-lg flex items-center justify-center gap-2 flex-wrap">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-7xl mx-auto">
              {/* Phone Card */}
              <div className="bg-white rounded-3xl shadow-xl p-8 text-center hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
                ...
                <a href="tel:+918595851017" className="text-2xl font-bold text-rose-600 hover:text-rose-700 transition-colors block mb-2">
                  +91 85958 51017
                </a>
              ...
              {/* WhatsApp Card */}
              <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-3xl shadow-xl p-8 text-center hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
                ...
                <a href="https://wa.me/918595851017" target="_blank" rel="noopener noreferrer" className="text-xl font-bold text-green-600 hover:text-green-700 transition-colors block mb-2">
                  Chat Now
                </a>
                <p className="text-gray-600">Quick & Private</p>
              </div>

              {/* Availability Card */}
              <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-3xl shadow-xl p-8 text-center hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
                ...
                <p className="text-xl font-bold text-blue-600 mb-2">24/7 Service</p>
                <p className="text-gray-600">Always Available</p>
              </div>

              {/* Email Card */}
              <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-3xl shadow-xl p-8 text-center hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
                ...
                <a href="mailto:info@stardigitech.com" className="text-xl font-bold text-purple-600 hover:text-purple-700 transition-colors block mb-2">
                  Send Message
                </a>
